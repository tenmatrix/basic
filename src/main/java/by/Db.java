...
//      }
   ...
   public static Connection getConnection() throws SQLException, IOException
   {
      ...
      //FileInputStream in = new FileInputStream(Thread.currentThread().getContextClassLoader().getResource("database.properties").getPath());
      URL propUrl=null;
      propUrl=Db.class.getClassLoader().getResource("database.properties");
      if(propUrl==null){
    	  propUrl=Db.class.getClassLoader().getResource("by/database.properties");
      }
